...
describe("Product List", () => {
    ...
    it("renders the name of the product", () => {
        let items = [{name: "Sunshine Plant", description: "Bright yellow like the sun", cost: "$18", image: {src: "assets/images/pic1.png", alt: "plant product"}}];
    
        let products = [{"category": "Aromatic Fragrant Plants", "plants" : items }]
